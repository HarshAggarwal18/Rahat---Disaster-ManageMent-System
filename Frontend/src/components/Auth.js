  ...
  return (
    <div className="gradient-bg min-h-screen flex items-center justify-center relative">
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-1">
        ...
        <div
          className="absolute top-60 left-80 w-12 h-12 bg-red-400 rounded-lg opacity-10 animate-float"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute top-80 left-20 w-20 h-20 bg-yellow-400 rounded-full opacity-10 animate-float"
          style={{ animationDelay: "4s" }}
        ></div>
        <div
          className="absolute top-30 left-70 w-14 h-14 bg-blue-400 rounded-lg opacity-10 animate-float"
      ...
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md mx-4 relative z-10">
        ...
        <div className="flex mb-6 bg-gray-100 rounded-lg p-1">
          <button
            ...
            className={`flex-1 py-2 px-4 rounded-md font-medium transition-colors ${
              activeTab === "login" ? "bg-blue-600 text-white" : "text-gray-600"
            }`}
          >
            Login
          </button>
        ...
        <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
          ...
          <p className="text-xs text-blue-700 mb-2">
            Use any credentials to login - this is a demo system
          </p>
          <div className="text-xs text-blue-600 space-y-1">
            <div>
              <strong>User:</strong> Reports incidents, tracks own incidents
            </div>
            <div>
              <strong>Volunteer:</strong> Takes assigned incidents, completes
              tasks
            </div>
            <div>
              <strong>Admin:</strong> Verifies incidents, manages system
            </div>
          </div>
        </div>
      </div>
